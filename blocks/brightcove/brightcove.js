...
export default function decorate(brightcove) {
  ...
  const OPEN_TRANSCRIPT_ICON = 'https://www.assets.lundbeck-tools.com/content/dam/lundbeck/vyepti/overhaul/images/expand-22-desktop.svg';

  const CLOSE_TRANSCRIPT_ICON = 'https://www.assets.lundbeck-tools.com/content/dam/lundbeck/vyepti/overhaul/images/collapse-22-desktop.svg';
