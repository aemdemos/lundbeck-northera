...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-symptomatic-noh-page.js
  var import_symptomatic_noh_page_exports = {};
  __export(import_symptomatic_noh_page_exports, {
    default: () => import_symptomatic_noh_page_default
  });
  ...
  // tools/importer/parsers/cards-symptoms.js
  function parse3(element, { document }) {
    ...
    teasers = teasers.filter((t) => {
      var _a;
      const key = (((_a = t.querySelector(".cmp-teaser__title, h1, h2, h3, h4, h5, h6")) == null ? void 0 : _a.textContent) || "").trim();
  ...
  // tools/importer/parsers/columns-supine.js
  function parse5(element, { document }) {
    const seenAlts = /* @__PURE__ */ new Set();
  ...
  var parsers = {
    embed: parse,
    accordion: parse2,
    "cards-symptoms": parse3,
    "cards-stats": parse4,
    "columns-supine": parse5,
    "fragment-isi": parse6
  };
  var transformers = [
    transform,
  ...
  var import_symptomatic_noh_page_default = {
    transform: (payload) => {
      const {
        document,
        url,
  ...
  return __toCommonJS(import_symptomatic_noh_page_exports);
})();
