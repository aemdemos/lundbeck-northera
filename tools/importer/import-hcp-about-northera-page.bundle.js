...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-hcp-about-northera-page.js
  var import_hcp_about_northera_page_exports = {};
  __export(import_hcp_about_northera_page_exports, {
    default: () => import_hcp_about_northera_page_default
  });
  ...
  // tools/importer/parsers/columns-oh-types.js
  ...
  var import_hcp_about_northera_page_default = {
    transform: (payload) => {
      const {
        document,
        url,
  ...
  return __toCommonJS(import_hcp_about_northera_page_exports);
})();
