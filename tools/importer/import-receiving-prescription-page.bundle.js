...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-receiving-prescription-page.js
  var import_receiving_prescription_page_exports = {};
  __export(import_receiving_prescription_page_exports, {
    default: () => import_receiving_prescription_page_default
  });
  ...
  var import_receiving_prescription_page_default = {
    transform: (payload) => {
      const {
        document,
        url,
  ...
  return __toCommonJS(import_receiving_prescription_page_exports);
})();
