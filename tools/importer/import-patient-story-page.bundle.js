...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-patient-story-page.js
  var import_patient_story_page_exports = {};
  __export(import_patient_story_page_exports, {
    default: () => import_patient_story_page_default
  });
  ...
  function parse2(element, { document }) {
    ...
    const quotationText = paragraphs.find((t) => /[“"]/.test(t) && t.length > 60) || paragraphs.sort((a, b) => b.length - a.length)[0];
    if (!quotationText) {
      element.replaceWith(...element.childNodes);
      return;
    }
  ...
  var parsers = {
    "columns-teaser": parse,
    "quote-patient": parse2,
    "cards-cta": parse3,
    "fragment-isi": parse4
  };
  var transformers = [
  ...
  return __toCommonJS(import_patient_story_page_exports);
})();
